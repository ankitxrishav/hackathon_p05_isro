      ...
      <CardContent>
        <Tabs defaultValue="geocoding">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="geocoding">Village Geocoding</TabsTrigger>
          ...
          <TabsContent value="geocoding">
            <div className="space-y-4 pt-4">
              ...
              <Button className="w-full" onClick={handleGeocode} disabled={geocodeLoading}>
          ...
          <TabsContent value="lulc">
            <div className="space-y-4 pt-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="aoi" className="min-h-[120px]" placeholder='e.g., { "type": "Polygon", "coordinates": [ ... ] }' value={aoi} onChange={(e) => setAoi(e.target.value)} />
              </div>
              <Button className="w-full" onClick={handleLulc} disabled={lulcLoading}>
